...
const CONTRACT_NAME = "NebulaAtlasFHE";
...
*/
export const NebulaAtlasABI = ${JSON.stringify({ abi: deployLocalhost.abi }, null, 2)} as const;
`;
const tsAddresses = `
/*
  This file is auto-generated.
  Command: 'npm run genabi'
*/
export const NebulaAtlasAddresses = { 
...
console.log(`Generated ${path.join(outdir, "NebulaAtlasABI.ts")}`);
console.log(`Generated ${path.join(outdir, "NebulaAtlasAddresses.ts")}`);

fs.writeFileSync(path.join(outdir, `NebulaAtlasABI.ts`), tsCode, "utf-8");
fs.writeFileSync(
  path.join(outdir, `NebulaAtlasAddresses.ts`),
  tsAddresses,
  "utf-8"
);
